  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      <div className={`relative ${containerClass}`}>
        ...
        {/* Inline CSS — pindahkan ke globals.css jika perlu */}
        <style jsx>{`
          .wheel-and-hamster {
            --dur: 1s;
            position: relative;
      ...
      {/* Pesan Loading */}
      <p className="text-lg font-medium text-gray-700 dark:text-gray-300 text-center max-w-xs">
        {message}
      </p>
      
      {/* Progress hint (opsional, tapi nice) */}
